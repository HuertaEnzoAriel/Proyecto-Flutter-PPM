...
//Se importa el paquete math de flutter para calcular la diagonal y se //le genera un alias
...
class Responsive {
  ...
  //Se considera tablet cuando el ancho es igual o mayor a 600 //(punto de corte típico en Flutter)
  bool get isTablet => _width >= 600;
  //Función estática que retorna una instancia de la clase responsive
